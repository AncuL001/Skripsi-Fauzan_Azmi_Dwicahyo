...
def main(cfg: Config):
    ...
    val_dataset = CoCoDatasetForYOLO(
        root=cfg.VAL_DATASET_PATH,
        annFile=cfg.val_anns_file_path,
    ...
    train_loop(model, train_dataset, val_dataset, optimizer, loss_fn, writer, cfg)
